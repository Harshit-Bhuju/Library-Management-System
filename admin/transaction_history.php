...
$stmt = $pdo->prepare("
    SELECT t.*, u.name as user_name, u.email as user_email, b.title as book_title
    FROM transactions t
...
<div class="dashboard-layout">
    ...
    <main class="main-content lg:mt-0 mt-16">
        <header class="mb-8">
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white">All Transactions</h1>
            <p class="text-gray-500 dark:text-gray-400 mt-1">Overview of all fine payments</p>
        </header>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-3">
                                            <?php echo getAvatar($t['user_name'], 32); ?>
                                            <div>
                                                <p class="font-medium text-sm dark:text-white leading-tight"><?php echo e($t['user_name']); ?></p>
                                                <p class="text-xs text-gray-500"><?php echo e($t['user_email']); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <p class="font-medium dark:text-white text-sm">Fine Payment</p>
                                        <?php if ($t['book_title']): ?>
